...
import { ItemDetailComponent } from "./transaction-detail/transaction-detail.component";
import { SearchComponent } from "./search/search.component";

export const COMPONENTS = [BrowseComponent, TransactionListComponent, ItemDetailComponent, SearchComponent];

const routes: Routes = [
    { path: "", redirectTo: "/(homeTab:home//browseTab:browse//searchTab:search)", pathMatch: "full" },

    { path: "home", component: TransactionListComponent, outlet: "homeTab" },
